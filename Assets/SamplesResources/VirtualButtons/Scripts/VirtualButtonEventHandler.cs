...
//            break;
		...
		case "Right":
			//ArmController.isDownUp = false;

			//ArmController.isLeft = true;
			//ArmController.isRight = false;
			break;


		case "Left":
			//ArmController.isRight = true;
			//ArmController.isLeft = false;
			//ArmController.isDownUp = false;
			break;
